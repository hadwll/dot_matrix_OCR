## This scriptis a test to check if the small resolution image can be classified
...
image = cv2.imread(r"C:\Users\hadwl\Documents\University\pervasive computing\Images\box_ocr\test_image.jpg")
dim = (800,600)
